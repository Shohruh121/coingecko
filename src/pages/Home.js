          ...
          {loading ? (
              <div className="row">
                    <div className="col-12">
                        ...
                        {search.length > 0 ? (
                           <>
                                {searchFilter.length > 0 ? ( <Table data={searchFilter} />
                                ) : ( 
                ...
                <div className="d-flex align-items-center justidy-content-center" style={{height:"80vh"}}> <div className="spinner-grow" 
                            role="status">
